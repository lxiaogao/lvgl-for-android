...
lv_obj_t * _lv_demo_music_main_create(lv_obj_t * parent)
{
    ...
    lv_obj_set_grid_cell(spectrum_obj, LV_GRID_ALIGN_STRETCH, 0, 1, (lv_grid_align_t)LV_GRID_ALIGN_CENTER, 6, 1);
    lv_obj_set_grid_cell(ctrl_box, LV_GRID_ALIGN_STRETCH, 0, 1, (lv_grid_align_t)LV_ALIGN_CENTER, 8, 1);
    lv_obj_set_grid_cell(handle_box, LV_GRID_ALIGN_STRETCH, 0, 1, (lv_grid_align_t)LV_ALIGN_CENTER, 10, 1);
#else
    /*Arrange the content into a grid*/
    ...
    lv_obj_set_grid_cell(handle_box, LV_GRID_ALIGN_STRETCH, 0, 2, (lv_grid_align_t)LV_ALIGN_CENTER, 8, 1);
    lv_obj_set_grid_cell(spectrum_obj, LV_GRID_ALIGN_STRETCH, 1, 1, (lv_grid_align_t)LV_GRID_ALIGN_CENTER, 1, 9);
#endif
...
static void spectrum_draw_event_cb(lv_event_t * e)
{
    ...
    if(code == LV_EVENT_REFR_EXT_DRAW_SIZE) {
        ...
        const lv_area_t * clip_area = (lv_area_t *)lv_event_get_param(e);
